...
```{r, eval=FALSE}
filePaths = ["data/align/UID-10X-Fibroblast-cell_SLX-00000_000001_AAACCTGAGCAGCCTC-1.bam",
             "data/align/UID-10X-Fibroblast-cell_SLX-00000_000001_AAACCTGAGCAGCCTC-1.bam"]
```
...
scaledCN = readRDS("/Users/darvis01/results/500/out.rds")
