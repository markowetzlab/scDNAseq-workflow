...
For this, we can create the environment from [this yml file](docs/CONTRIBUTING.md) and then activate it.
...
In the next step, we can run the [run_plotCopynumber script](scripts/run_plotCopynumber.R) with two arguments.
...
here is an example command for running plotCopynumber script on the results of this example.  
